...
DEFAULT_INPUT = PROJECT_DIR / "DCR_RAW_STANDARDIZED_4div_2026-03-01_2026-03-31_Div42.xlsx"
DEFAULT_OUTPUT = PROJECT_DIR / "out_jan_div42.csv"
...
def build_output_in_template_format(
    ...
    print(
        f"SlotMAX Div42: Date column -> report month={report_jan} | baseline months={baseline_months}",
        flush=True,
    )
